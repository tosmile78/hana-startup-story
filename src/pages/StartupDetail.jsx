  ...
  if (!startup) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-12 text-center">
        ...
        <Link to="/" className="inline-block bg-hana text-white px-6 py-3 rounded-full font-medium transition-all hover:shadow-card-lg">
          목록으로 돌아가기
        </Link>
      </div>
    );
  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="bg-card rounded-radius-card border border-border-card p-6 md:p-8 shadow-card">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <img
          ...
          alt={startup.name}
          loading="lazy"
          className="w-full h-60 md:h-80 object-cover rounded-radius-card shadow-card"
        />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <p className="text-base md:text-lg leading-relaxed text-secondary whitespace-pre-wrap">
          {startup.story}
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-section rounded-radius-card p-8 border-l-4" style={{ borderLeftColor: startup.brandColor }}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {startup.stats.map((stat, idx) => (
            <div
              key={idx}
              className="bg-card rounded-radius-card p-6 border border-border-card text-center shadow-card hover:shadow-card-lg transition"
            >
              <p className="text-3xl md:text-4xl font-bold text-hana mb-2">
                {stat.value}
              </p>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="block w-full bg-hana text-white text-center py-4 rounded-radius-card font-bold text-lg transition-all hover:shadow-card-lg"
        >
          공식 홈페이지 방문하기
        </a>
      </div>
